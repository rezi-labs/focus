...
- [Taste - a music explorer](https://github.com/rezi-labs/taste)
- [Me - my personal website](https://github.com/LunchTimeCode/me)
- [Jobs - scraping job postings](https://github.com/LunchTimeCode/jobs)
...
- I want to write html: maud
- I want to write a CLI: clap
- I want to use other CLIs in my CLI: xshell
- I want to write have a config file: serde and serde\_\*
- I want to have a nice frontend: tailwind / daisy ui / htmx
- I want to have simulations visualized in 200 fps: egui

If I want to do embedded, I can. If I want to write an operating system, I could if I had the skill...
